...
private val sky = mapOf("CLEAR_DAY" to Sky("晴",R.drawable.ic_clear_day, R.drawable.bg_clear_day),
    ...
    "CLOUDY" to Sky("阴",R.drawable.ic_cloudy, R.drawable.bg_partly_cloudy_day),
    ...
    "STORE_RAIN" to Sky("暴雨",R.drawable.ic_storm_rain, R.drawable.bg_rain),
    ...
    "LIGHT_HAZE" to Sky("小雪",R.drawable.ic_light_snow, R.drawable.bg_snow),
    ...
    "STORE_SNOW" to Sky("暴雪",R.drawable.ic_heavy_snow, R.drawable.bg_snow),
